...
import org.apache.flink.runtime.rest.handler.legacy.backpressure.StackTraceSingleSample;
 ...
 */
public class StackTraceSampleResponse extends BackPressureSampleResponse<StackTraceSingleSample> {
	...
	public StackTraceSampleResponse(
		...
		super(
			sampleId,
			executionAttemptID,
			new StackTraceSingleSample(samples));
	}
}
